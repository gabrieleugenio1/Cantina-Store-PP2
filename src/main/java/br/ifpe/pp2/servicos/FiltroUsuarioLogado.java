...
public class FiltroUsuarioLogado implements Filter{
	private String[] pathsLiberados = { "/","/login","/login/usuario","/meuspedidos", "/cadastro", "/salvar/novousuario","/criarnovotipo","/gerenciamento","/criarnovoproduto", "/h2-console(.*)" ,"/css(.*)", "/js(.*)"};
	@Override
