...
public class FiltroAdmin implements Filter{
	...
	private String[] pathsLiberadosLogadoAdmin = { "/","/modificarPedidos","/modificarcategoria","/minhaconta","/alterardados","/carrinho","/login","/login/usuario","/meuspedidos","/logout","/admin","/entrar/admin", "/cadastro", "/salvar/novousuario","/criarnovotipo","/gerenciamento","/criarnovoproduto", "/foto(.*)","/h2-console(.*)" ,"/css(.*)", "/js(.*)"};
